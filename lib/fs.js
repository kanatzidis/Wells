...
module.exports = function(base) {
  ...
  ipc.connectTo('world', function(){
    ...
    ipc.of.world.on('cmd', function(data){
    ...
    // This is required to tell the main process that setup is complete
    // This should actually just emit a 'start' event but time is limited so
